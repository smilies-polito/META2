...
class RandomForest_C:
    def __init__(self, n_estimators=100, criterion='gini', max_features=1,min_samples_split=2,bootstrap=True, convert_dtype=False):
        #criteiron=absolute_error
        #max_features = "sqrt"
        self.model = RandomForestClassifier(n_estimators=n_estimators, criterion=criterion, max_features=max_features, min_samples_split=min_samples_split,bootstrap=bootstrap)
        self.convert_dtype = convert_dtype
